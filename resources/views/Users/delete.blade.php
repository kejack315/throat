<x-guest-layout>
    ...
    <section class="w-full p-6 flex flex-col gap-4">
        ...
        <div class="flex flex-row gap-4 rounded-md
            ...
            <p class="p-2 w-5/6">{{ $user->email }}</p>
        </div>
        ...
        <div class="flex flex-row gap-4 rounded-md
            ...
            <p class="p-2 w-5/6">{{ $user->passwords }} </p>
        </div>
        ...
        <div class="flex flex-row gap-4 rounded-md
            ...
            <p class="p-2 w-5/6">{{ $user->created_at }} </p>
        </div>
        ...
        <div class="flex flex-row gap-4 rounded-md
            ...
            <p class="p-2 w-5/6">{{ $user->updated_at }} </p>
        </div>
